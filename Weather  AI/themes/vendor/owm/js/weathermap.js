! function() {
    ...
    1: [function(t, e, i) {
        ...
        L.Control.Search = L.Control.extend({
            ...
            onAdd: function(t) {
                ...
                n.href = "#", n.style.width = "26px", n.style.height = "26px", n.style.backgroundImage = "url(" + this._icon + ")", n.style.backgroundSize = "26px 26px", n.style.backgroundRepeat = "no-repeat", n.title = this.options.title;
                var o = L.DomEvent.stopPropagation;
                L.DomEvent.on(n, "click", o).on(n, "mousedown", o).on(n, "dblclick", o).on(n, "click", L.DomEvent.preventDefault).on(n, "click", this._toggle, this);
                var a = this._form = document.createElement("form");
                a.style.display = "none", a.style.position = "absolute", a.style.left = "27px", a.style.top = "0px", a.style.zIndex = -10;
                var r = this._input = document.createElement("input");
                return r.style.height = "25px", r.style.border = "1px solid grey", r.style.padding = "0 0 0 10px", a.appendChild(r), L.DomEvent.on(a, "submit", function() {
                    return this._doSearch(r.value), !1
                }, this).on(a, "submit", L.DomEvent.preventDefault), e.appendChild(a), e
            },
            _toggle: function() {
                "block" != this._form.style.display ? (this._form.style.display = "block", this._input.focus()) : this._collapse()
            },
            _collapse: function() {
            ...
            _doSearch: function(t) {
                ...
                this.options.email && (i.email = this.options.email), this._map.getBounds() && (i.viewbox = this._map.getBounds().toBBoxString());
                var n = "//nominatim.openstreetmap.org/search" + L.Util.getParamString(i),
                    o = document.createElement("script");
                o.type = "text/javascript", o.src = n, document.getElementsByTagName("head")[0].appendChild(o)
            },
        ...
        L.TileLayer.Ajax = L.TileLayer.extend({
            ...
            _xhrHandler: function(t, e, i, n) {
                return function() {
                    if (4 === t.readyState) {
                        var o = t.status;
                        o >= 200 && o < 300 || 304 === o ? (i.datum = JSON.parse(t.responseText), e._tileLoaded(i, n)) : e._tileLoaded(i, n)
                    }
                }
            },
            _loadTile: function(t, e) {
                ...
                this._requests.push(n), n.onreadystatechange = this._xhrHandler(n, i, t, e), n.open("GET", this.getTileUrl(e), !0), n.send()
            },
            _reset: function() {
            ...
            _update: function() {
                this._map && this._map._panTransition && this._map._panTransition._inProgress || (this._tilesToLoad < 0 && (this._tilesToLoad = 0), L.TileLayer.prototype._update.apply(this, arguments))
            }
        }), L.TileLayer.GeoJSON = L.TileLayer.Ajax.extend({
            _keyLayers: {},
            _clipPathRectangles: {},
            initialize: function(t, e, i) {
                L.TileLayer.Ajax.prototype.initialize.call(this, t, e), this.geojsonLayer = new L.GeoJSON(null, i)
            },
            onAdd: function(t) {
                this._map = t, L.TileLayer.Ajax.prototype.onAdd.call(this, t), t.addLayer(this.geojsonLayer)
            },
            onRemove: function(t) {
                t.removeLayer(this.geojsonLayer), L.TileLayer.Ajax.prototype.onRemove.call(this, t)
            },
            _reset: function() {
                this.geojsonLayer.clearLayers(), this._keyLayers = {}, this._removeOldClipPaths(), L.TileLayer.Ajax.prototype._reset.apply(this, arguments)
            },
            _removeOldClipPaths: function() {
                for (var t in this._clipPathRectangles) {
                    ...
                    if (parseInt(e[0], 10) !== this._map.getZoom()) {
                        ...
                        null !== n && n.parentNode.removeChild(n), delete this._clipPathRectangles[t]
                    }
                }
            },
            _recurseLayerUntilPath: function(t, e) {
                e instanceof L.Path ? t(e) : e instanceof L.LayerGroup && e.getLayers().forEach(this._recurseLayerUntilPath.bind(this, t), this)
            },
            _clipLayerToTileBoundary: function(t, e) {
                if (L.Path.SVG && this._map) {
                    this._map._pathRoot || (this._map._pathRoot = L.Path.prototype._createElement("svg"), this._map._panes.overlayPane.appendChild(this._map._pathRoot));
                    var i = this._map._pathRoot,
                        n = null;
                    0 === i.getElementsByTagName("defs").length ? (n = document.createElementNS(L.Path.SVG_NS, "defs"), i.insertBefore(n, i.firstChild)) : n = i.getElementsByTagName("defs")[0];
                    var o = "tileClipPath_" + e.z + "_" + e.x + "_" + e.y,
                        a = document.getElementById(o);
                    if (null === a) {
                        a = document.createElementNS(L.Path.SVG_NS, "clipPath"), a.id = o;
                        var r = this.options.tileSize,
                            s = e.multiplyBy(r),
                            l = s.add([r, r]),
                            h = this._map.unproject(s),
                            u = this._map.unproject(l);
                        this._clipPathRectangles[o] = new L.Rectangle(new L.LatLngBounds([h, u]), {
                            opacity: 0,
                            fillOpacity: 0,
                            clickable: !1,
                            noClip: !0
            ...
            addTileData: function(t, e) {
                var i, n, o, a = L.Util.isArray(t) ? t : t.features;
                if (a) {
                    for (i = 0, n = a.length; i < n; i++) o = a[i], (o.geometries || o.geometry || o.features || o.coordinates) && this.addTileData(a[i], e);
                    return this
                }
                ...
                if (!r.filter || r.filter(t)) {
                    ...
                    if (this.options.unique && "function" == typeof this.options.unique) {
                        ...
                        h in this._keyLayers && "GeometryCollection" !== t.geometry.type || (t.geometry = {
                            type: "GeometryCollection",
                            geometries: [t.geometry]
                        });
                        try {
                            l = L.GeoJSON.geometryToLayer(t, r.pointToLayer, r.coordsToLatLng)
                        } catch (t) {
                            return this
                        }
                        l.feature = L.GeoJSON.asFeature(t), h in this._keyLayers ? (s = this._keyLayers[h], s.feature.geometry.geometries.push(t.geometry)) : this._keyLayers[h] = l
                    } else {
                        try {
                            l = L.GeoJSON.geometryToLayer(t, r.pointToLayer, r.coordsToLatLng)
                        } catch (t) {
                    ...
                    return l.defaultOptions = l.options, this.geojsonLayer.resetStyle(l), r.onEachFeature && r.onEachFeature(t, l), s.addLayer(l), this.options.clipTiles && this._clipLayerToTileBoundary(l, e), this
                }
            },
            _tileLoaded: function(t, e) {
                if (L.TileLayer.Ajax.prototype._tileLoaded.apply(this, arguments), null === t.datum) return null;
    ...
    4: [function(t, e, i) {
        ...
        var o = function() {
            ...
            a = function() {
                function t(e) {
                    n(this, t), this.params = e, this.attributionUrbica = "OpenWeatherMap " + (new Date).getFullYear() + " | Design by <a href='https://hauhet.co' target='_blank'>HauHet plc.</a>", this.attribution = '&copy; <a href="https://carto.com/basemaps" target="_blank">CARTO Basemaps</a> | <a href="https://openweathermap.org/"  target="_blank">OpenWeather</a>', this.layers = {}, this.baseURL = "//{s}.maps.owm.io", this.layers.satellite = new L.tileLayer("//{s}.sat.owm.io/sql/{z}/{x}/{y}/?select=b1,b4,b3&from=terra&order=last&color=modis&where=now-1&appid=" + this.params.appidWeatherLayer, {
                        maxZoom: 18,
                        id: "satellite",
                        attribution: "NASA",
                        subdomains: "abcdefgh",
                        zIndex: 0,
                        showWeather: !0
                    }), this.layers.vector = new L.tileLayer("//cartodb-basemaps-{s}.global.ssl.fastly.net/dark_all/{z}/{x}/{y}.png", {
                        ...
                        subdomains: "abcd",
                        showWeather: !0
                    }), this.layers.precipitation = new L.tileLayer("//{s}.sat.owm.io/vane/2.0/weather/PA0/{z}/{x}/{y}?appid=" + this.params.appidWeatherLayer + "&palette=0.9:00fa96;1.8:00fa64;2.4:00e600;3:00d300;4.5:00ba00;6:00a000;9:008c00;10.5:007800;11.1:006400;12:005a00;15:005000;18:004600;21:eff800;24:f3eb00;27:fadc00;30:ffcd00;36:ff9600;42:ff5b00;48:ff0000;72:ff0064;96:ff0092;192:aa2bc3;300:7609a4&opacity=0.8", {
                        name: "precipitation",
                        attribution: this.attribution,
                        maxZoom: 18,
                        zIndex: 1,
                    ...
                    }), this.layers.pressure = new L.tileLayer("//{s}.sat.owm.io/vane/2.0/weather/APM/{z}/{x}/{y}?appid=" + this.params.appidWeatherLayer, {
                        name: "pressure",
                        attribution: this.attribution,
                        maxZoom: 18,
                        zIndex: 1,
                    ...
                    }), this.layers.temperature = new L.tileLayer("//{s}.sat.owm.io/vane/2.0/weather/TA2/{z}/{x}/{y}?appid=" + this.params.appidWeatherLayer + "&fill_bound=true", {
                        name: "temperature",
                        attribution: this.attribution,
                        maxZoom: 18,
                        zIndex: 1,
                    ...
                    }), this.layers.windspeed = new L.tileLayer("//{s}.sat.owm.io/vane/2.0/weather/WS10/{z}/{x}/{y}?appid=" + this.params.appidWeatherLayer, {
                        name: "windspeed",
                        attribution: this.attribution,
                        maxZoom: 18,
                        zIndex: 1,
                    ...
                    }), this.layers.clouds = new L.tileLayer("//{s}.sat.owm.io/vane/2.0/weather/CL/{z}/{x}/{y}?appid=" + this.params.appidWeatherLayer, {
                        name: "clouds",
                        attribution: this.attribution,
                        maxZoom: 18,
                        zIndex: 1,
                    ...
                    }), this.layers.prs = new L.tileLayer(this.baseURL + "/weather/pressure_cntr/{z}/{x}/{y}.png?appid=" + this.params.appid, {
                        attribution: this.attribution,
                        maxZoom: 18,
                        zIndex: 1
                    })
                ...
                return o(t, [{
                    ...
                    value: function() {
                        ...
                        return t.getUTCFullYear() + "-" + this.leadingZeroes(t.getUTCMonth() + 1) + "-" + this.leadingZeroes(t.getUTCDate()) + "T" + this.leadingZeroes(t.getUTCHours()) + ":" + this.leadingZeroes(e)
                    }
                }]), t
            }();
        i.default = a
    ...
    5: [function(t, e, i) {
        ...
        var o = function() {
            ...
            s = function() {
                function t(e, i) {
                    n(this, t), this.location = e, this.parseURL = (0, r.default)(e.href)
                }
                return o(t, [{
                    key: "getArrayURI",
                    value: function() {
                    ...
                    value: function(t) {
                        var e = this.getArrayURI(),
                            i = "";
                        this.uriParams.length && (this.uriParams.forEach(function(n) {
                            !e[n] && t[n] && (i += "&" + n + "=" + t[n]), e[n] && !t[n] && (i += "&" + n + "=" + e[n]), e[n] && t[n] && (i += "&" + n + "=" + t[n])
                        }.bind(this)), i.substr(1) !== this.location.search.substr(1) && (this.location.search = i ? "?" + i.substr(1) : "", console.log(i)))
                    }
                }, {
                    ...
                    value: function(t) {
                        ...
                        this.uriParams.length && (this.uriParams.forEach(function(n) {
                            ...
                            !r && s && (i += "&" + n + "=" + a), r && !s && (i += "&" + n + "=" + o), r && s && (i += "&" + n + "=" + a)
                        }.bind(this)), i.substr(1) !== this.location.search.substr(1) && history.pushState({
                            foo: "bar"
                        }, "Title", "?" + i.substr(1)))
                    }
                }, {
                    ...
                    value: function(t) {
                        var e = this.getArrayURI();
                        e.uri = "", Object.keys(e).forEach(function(i) {
                            "uri" !== i && (i === t ? delete e[t] : e.uri += "&" + i + "=" + e[i])
                        }), window.history.pushState({
                            foo: "bar"
                        }, "Title", "?" + e.uri.substr(1))
                    }
                }, {
                    key: "setDefaultURI",
                    value: function(t) {
    ...
    6: [function(t, e, i) {
        ...
        var n = {
            CLOUDS_STYLE: [{
                value: 0,
                color: "rgba(247,247,255, 0)"
            }, {
                value: 10,
                color: "rgba(251,247,255, 0)"
            }, {
                value: 20,
                color: "rgba(244,248,255, 0.1)"
            }, {
                value: 30,
                color: "rgba(240,249,255, 0.2)"
            }, {
                value: 40,
                color: "rgba(221,250,255, 0.4)"
            }, {
                value: 50,
            ...
            RADAR_RAIN: [{
                ...
                value: .3,
                color: "rgba(0,250,150,150)"
            }, {
                value: .6,
                color: "rgba(0,250,100,255)"
            }, {
                value: .8,
                color: "rgba(0,230,0,255)"
            }, {
                value: 1,
                color: "rgba(0,211,0,255)"
            }, {
                value: 1.5,
                ...
                value: 4,
                color: "rgba(0,90,0,255)"
            }, {
                value: 5,
                color: "rgba(0,80,0,255)"
            }, {
                value: 6,
                color: "rgba(0,70,0,255)"
            }, {
                value: 7,
                color: "rgba(239,248,0,255)"
            }, {
                value: 8,
                color: "rgba(243,235,0,255)"
            }, {
                value: 9,
                color: "rgba(250,220,0,255)"
            }, {
                value: 10,
                ...
                value: 32,
                color: "rgba(255,0,146,255)"
            }, {
                value: 60,
                color: "rgba(170,43,195,255)"
            }],
            RADAR_RAIN_SHORT: [{
                value: 0,
                color: "rgba(0,0,0,0)"
    ...
    8: [function(t, e, i) {
        ...
        var o = function() {
            ...
            s = function() {
                function t(e, i) {
                    n(this, t), this.params = i, this.params.iconLayer = i.iconLayer || "", this.map = e;
                    var o = this;
                    e.on("click", function(t) {
                        o.onClickOnMap(), this.params.url.setURIParamsNotReloadPage({
                            lat: t.latlng.lat.toFixed(4),
                            lon: t.latlng.lng.toFixed(4),
                            zoom: t.target.getZoom()
                        })
                    }.bind(this)), this.bindCities = function(t, i, n) {
                        this.params.flagCities.checked ? (this.map.hasLayer(i) || this.map.addLayer(i), this.map.hasLayer(n) && this.map.removeLayer(n)) : (this.map.hasLayer(i) && this.map.removeLayer(i), this.map.hasLayer(n) || this.map.addLayer(n)), this.params.flagCities.addEventListener("change", function(t) {
                            t.target.checked ? (e.hasLayer(i) || e.addLayer(i), e.hasLayer(n) && e.removeLayer(n), this.params.url.setURIParamsNotReloadPage({
                                cities: "true"
                            })) : (e.hasLayer(i) && e.removeLayer(i), e.hasLayer(n) || e.addLayer(n), this.params.url.setURIParamsNotReloadPage({
                                cities: "false"
                            }))
                        }.bind(this)), this.appendBaseLayerByURIParams()
                    }, this.bindScales = function() {
                        o._colorScaleControl = o.getCustomColorScale().addTo(e), e.on("overlayadd", function(t) {
                            var e = t.layer.options.scaleParams;
                            o._colorScaleControl._updateScales(e), t.layer.options.name && this.params.url.setURIParamsNotReloadPage({
                        ...
                        for (var n in t)
                            if (t.hasOwnProperty(n) && t[n].options.name === i) {
                                this._colorScaleControl._updateScales(t[n].options.scaleParams);
                                break
                            }
                        ...
                        function n(t) {
                            t || (t = x);
                            return "radar" === g ? t.getUTCFullYear() + "-" + i(t.getUTCMonth() + 1) + "-" + i(t.getUTCDate()) + "T" + i(t.getUTCHours()) + ":" + i(t.getUTCMinutes()) : t.getTime() / 1e3
                        }

                        function a() {
                            var t = parseInt(o.params.controlRange.value);
                            t > D - T ? (o.params.playForwardFaster.disabled = !0, o.params.playForward.disabled = t === D, o.params.playBack.disabled = !1, o.params.playBackFaster.disabled = !1) : t < T ? (o.params.playBackFaster.disabled = !0, o.params.playBack.disabled = 1 === t, o.params.playForward.disabled = !1, o.params.playForwardFaster.disabled = !1) : (o.params.playBack.disabled = !1, o.params.playBackFaster.disabled = !1, o.params.playForward.disabled = !1, o.params.playForwardFaster.disabled = !1)
                        }

                        function r(e, i, n) {
                            i.setOpacity(0), n || (n = 50), t.hasLayer(i) || (o.handlingClickplayControl = !0, t.addLayer(i));
                            var a = 0,
                                r = setInterval(function() {
                                    a >= .6 && t.hasLayer(e) && (o.handlingClickplayControl = !0, t.removeLayer(e), e.options.dataKey && delete w[e.options.dataKey], o.handlingClickplayControl = !1), a >= 1 && clearInterval(r), a += .2, a > .8 && (a = 1), e.setOpacity(1 - a), i.setOpacity(a)
                                }, n)
                        }

                        function s(t, i, s) {
                            x.setMinutes(x.getUTCMinutes() + t), o.params.currMoment.innerHTML = l(x), x.getTime() !== e.getTime() ? (k.checked && k.click(), k.disabled = !0) : k.disabled = !1;
                            var h;
                            h = x.getTime() in w ? w[x.getTime()] : L.tileLayer(b + n(), v.options), r(v, h, i), v = h, !1 !== s && (o.params.controlRange.value = parseInt(o.params.controlRange.value) + t / C), a()
                        }
                        ...
                        function u() {
                            for (var e in t._layers) t._layers[e].options.name === g && t._layers[e] !== v && t.removeLayer(t._layers[e])
                        }
                        ...
                        function p() {
                            v = null, "handlingClickplayControl" in o || Object.defineProperty(o, "handlingClickplayControl", {
                                value: !1,
                                writable: !0
                            }), P && m(), k = document.getElementById("citiesConditions"), k.disabled = !1, _ = new URL(window.location), g = _.searchParams.get("layer");
                            for (var i in t._layers) t._layers[i].options.name !== g && (t._layers[i].options.name || t._layers[i].options.dataKey) ? t.removeLayer(t._layers[i]) : t._layers[i].options.name === g && (v = t._layers[i]);
                            v && v.setOpacity(1), S = new Date(e.getTime()), M = new Date(e.getTime()), "radar" === g ? (C = 10, T = 6, D = 1440 / C, E = D, y = "day", S.setDate(M.getUTCDate() - 1), o.params.playForward.disabled = !0, o.params.playForwardFaster.disabled = !0) : (C = 180, T = 8, D = 20160 / C, E = D / 2, y = "date", S.setDate(M.getUTCDate() - 7), M.setDate(M.getUTCDate() + 7), o.params.playForward.disabled = !1, o.params.playForwardFaster.disabled = !1), o.params.playBack.disabled = !1, o.params.playBackFaster.disabled = !1, x = new Date(e.getTime()), o.params.controlRange.max = D, o.params.controlRange.value = E, b = function() {
                                for (var e in t._layers)
                                    if (t._layers[e].options.name === g) {
                                        var i = t._layers[e]._url;
                                        i = i.includes(y) ? i.slice(0, i.indexOf(y + "=") + y.length + 1) : i + "&" + y + "=";
                                        break
                                    }
                                return i
                            }(), w = {}, o.params.currMoment.innerHTML = l(e), o.params.minDate.innerHTML = h(S), o.params.maxDate.innerHTML = h(M)
                        }

                        function d() {
                            o.params.play.style.display = "none", o.params.stop.style.display = "inline-block", x.getTime() === e.getTime() && (x.setDate(S.getDate()), o.params.controlRange.value = 1);
                        ...
                        function m() {
                            clearInterval(P), u(), o.handlingClickplayControl = !1, o.params.play.style.display = "inline-block", o.params.stop.style.display = "none"
                        }

                        function f() {
                            var t = new Date(e.getTime()),
                                i = parseInt(o.params.controlRange.value);
                            "radar" === g ? t.setMinutes(t.getMinutes() - (D - i) * C) : t.setMinutes(t.getMinutes() - (D / 2 - i) * C), s((t - x) / 6e4, 100, !1)
                        }
                        var _, g, v, y, b, P, x, w, C, T, E, D, S, M, k;
                        p(), this.params.playBack.addEventListener("click", function() {
                            return s(-C, 100)
                        }), this.params.playBackFaster.addEventListener("click", function() {
                            return s(-T * C, 100)
                        }), this.params.playForward.addEventListener("click", function() {
                            return s(C, 100)
                        }), this.params.playForwardFaster.addEventListener("click", function() {
                            return s(T * C, 100)
                        }), this.params.play.addEventListener("click", function() {
                            return d()
                        }), this.params.stop.addEventListener("click", function() {
                            return m()
                        }), this.params.controlRange.addEventListener("change", function() {
                            return f()
                        }), this.appendBaseLayerByURIParams(), t.on("overlayadd", function(t) {
                            p()
                        }.bind(this))
                        ...
                        initialize: function(t, e, i) {
                            L.setOptions(this, i), this._layers = {}, this._lastZIndex = 0, this._handlingClick = !1;
                        ...
                        _initLayout: function() {
                            ...
                            if (this.options.collapsed) {
                                var n = this._layersLink = L.DomUtil.create("div", t + "-toggle", e);
                                n.innerText = "Layers", L.Browser.android || L.DomEvent.on(n, "click", this._toogle, this), L.Browser.touch ? L.DomEvent.on(n, "click", L.DomEvent.stop).on(n, "click", this._expand, this) : L.DomEvent.on(n, "focus", this._expand, this), L.DomEvent.on(i, "click", function() {
                                    setTimeout(L.bind(this._onInputClick, this), 0)
                                }, this), this._map.on("click", this._collapse, this)
                            } else this._expand();
                            L.DomUtil.create("div", t + "-separator", i), this._baseLayersList = L.DomUtil.create("div", t + "-base", i), this._separator = L.DomUtil.create("div", t + "-separator", i), this._overlaysList = L.DomUtil.create("div", t + "-overlays", i), e.appendChild(i)
                        },
                        _changeCheckedLayer: function() {
                            ...
                            for (var n in i)
                                if (i.hasOwnProperty(n) && i[n].id === e) return i[n].checked = !0, void this._onInputClick();
                            i["Base map"].checked = !0, this._onInputClick(), document.location.hash = ""
                        },
                        ...
                        _update: function() {
                            if (this._container) {
                                ...
                                this._separator.style.display = n && i ? "" : "none", n ? this._overlaysList.className += " weather-control-layers-last" : this._baseLayersList.className += " weather-control-layers-last"
                            }
                        },
                        _onLayerChange: function(t) {
                            var e = this._layers[L.stamp(t.layer)];
                            if (e) {
                                this._handlingClick || o.handlingClickplayControl || this._update();
                                var i = e.overlay ? "layeradd" === t.type ? "overlayadd" : "overlayremove" : "layeradd" === t.type ? "baselayerchange" : null;
                                i && this._map.fire(i, e)
                            }
                        },
                        _createRadioElement: function(t, e, i) {
                            var n = '<input type="radio" id="' + e + '" class="weather-control-layers-selector" name="' + t + '"';
                            i && (n += ' checked="checked"'), n += "/>";
                            var o = document.createElement("div");
                            return o.innerHTML = n, o.firstChild
                        },
                        _addItem: function(t) {
                            var e, i = t.overlay ? this._overlaysList : this._baseLayersList,
                                n = L.DomUtil.create("div", "weather-layer-container", i),
                                o = document.createElement("label"),
                                a = this._map.hasLayer(t.layer);
                            o.htmlFor = t.name, t.overlay ? (e = document.createElement("input"), e.type = "radio", e.id = t.name, e.name = "Parameters", e.className = "weather-control-layers-selector", e.defaultChecked = a) : e = this._createRadioElement("weather-overlay-layers", t.name, a), e.layerId = L.stamp(t.layer), L.DomEvent.on(e, "click", this._onInputClick, this);
                            var r = document.createElement("span");
                            return r.innerHTML = " " + t.name, n.appendChild(e), o.appendChild(r), n.appendChild(o), o
                        },
                        ...
                        _expand: function() {
                            L.DomUtil.addClass(this._container, "weather-control-layers-expanded")
                        },
                        _collapse: function() {
                            this._container.className = this._container.className.replace(" weather-control-layers-expanded", "")
                        },
                        _toogle: function() {
                            this._container.className.indexOf(" weather-control-layers-expanded") > -1 ? this._collapse() : this._expand()
                        }
                        ...
                        onAdd: function(t) {
                            this._map = t;
                            return this.container = L.DomUtil.create("div", "leaflet-control-color-scale"), this._addScales("leaflet-control-color-scale"), this.container
                        },
                        onRemove: function(t) {},
                        _addScales: function(t) {
                            this._CScale = L.DomUtil.create("div", t + "-line", this.container), this._updateScales()
                        },
                        _updateScales: function(t) {
                            if (t) {
                                var e = t.gradient;
                                this._CScale.innerHTML = "", e.forEach(function(e, i) {
                                    this.container.style.display = "block", this.container.style.background = "none", this.container.style.boxShadow = "none", this.container.style.borderRadius = "none", this.container.style.borderWidth = 0, this.container.style.marginRight = "10px", this.container.style.width = parseInt(t.width) + 60 + "px", this.container.style.height = 27 * (i + 1) + "px", this._CScale.style.backgroundImage = "none", this._CScale.style.position = "relative", this._CScale.style.borderWidth = 0,
                                        this._CScale.style.margin = 0;
                                    var n = document.createElement("div");
                                    n.className = "scale-details";
                                    var o = document.createElement("div");
                                    o.innerHTML = t.legend.length ? t.legend[i] + ", " + t.siText : "", n.appendChild(o);
                                    if (t.linearScale) {
                                        var a = document.createElement("div");
                                        a.className = "scale-gradient", a.style.width = "260px";
                                        var r = Math.round(e[0].value),
                                            s = Math.round(e[e.length - 1].value),
                                            l = Math.round((s - r) / 4),
                                            h = document.createElement("div");
                                        h.className = "scale-dividers";
                                        for (var u = 0; u <= 4; u++) h.innerHTML += "<div>" + (r + l * u) + "</div>";
                                        a.appendChild(h);
                                        var c = document.createElement("div");
                                        c.className = "horizontal-gradient-line";
                                        for (var p = "", d = e.length, m = (e[d - 1].value - e[0].value) / 100, f = 0 - e[0].value, u = 0; u < e.length; u++) p += e[u].color + " " + (e[u].value + f) / m + "%", u < e.length - 1 && (p += ", ");
                                        c.style.backgroundImage = "linear-gradient(to right, " + p + ")", a.appendChild(c), n.appendChild(a), this._CScale.appendChild(n)
                                    } else {
                                        var _ = document.createElement("div"),
                                            g = document.createElement("div");
                                        _.style.width = "260px", g.style.width = "260px", _.className = "horizontal-gradient-line", g.className = "horizontal-gradient-values", g.className = "scale-dividers ";
                                        for (var v = "linear-gradient(to left ", u = e.length - 1; u >= 0; u--) v += ", " + e[u].color;
                                        v += ")", _.style.background = v, e.forEach(function(t) {
                                            g.innerHTML += "<div>" + t.value + "</div>"
                                        });
                                        var y = document.createElement("div");
                                        y.className = "gradient-container", y.appendChild(g), y.appendChild(_), n.appendChild(y), this._CScale.appendChild(n), this._CScale.appendChild(n)
                                    }
                                }.bind(this))
                            } else this.container.style.display = "none", this._CScale.style.backgroundImage = "none", this._CScale.innerHTML = ""
                        }
                        ...
                        enterDate: function() {
                            ...
                            t.setMinutes(t.getMinutes() - 8);
                            var e = 10 * Math.floor(t.getUTCMinutes() / 10);
                            return t.setMinutes(e), t.setSeconds(0), t.setMilliseconds(0), t
                        }(),
                        options: {
                            position: "topright"
                        },
                        onAdd: function(t) {
                            return this._div = L.DomUtil.create("div", "play-control"), L.DomEvent.disableClickPropagation(this._div), this.update(), this._div
                        },
                        update: function(t) {
                            function e(t, e) {
                                e = Object.assign(e);
                            ...
                            var i, n, o, a;
                            i = document.createElement("div"), n = document.createElement("div"), o = document.createElement("div"), a = document.createElement("div");
                            var r = e("button", {
                                    id: "play-back-faster"
                                }),
                                s = e("img", {
                                    src: "/app/Weather/themes/img/owm_icons/icon_down_black.svg"
                                });
                            r.appendChild(s), r.appendChild(s.cloneNode(!0)), i.append(r);
                            var l = e("button", {
                                id: "play-back"
                            });
                            l.id = "play-back", l.appendChild(s.cloneNode(!0)), i.append(l);
                            var h = e("button", {
                                    id: "play"
                                }),
                                u = e("img", {
                                    src: "/app/Weather/themes/img/owm_icons/icon_down_white.svg"
                                });
                            ...
                            var c = e("button", {
                                ...
                                p = e("img", {
                                    src: "/app/Weather/themes/img/owm_icons/icon_pause_black.png"
                                });
                            ...
                            document.createElement("button"), m.appendChild(s.cloneNode(!0)), m.appendChild(s.cloneNode(!0)), i.append(m);
                            var f = e("span", {
                                id: "current-moment"
                            });
                            n.append(f);
                            ...
                            a.appendChild(g), a.appendChild(v), this._div.appendChild(i), this._div.appendChild(n), this._div.appendChild(o), this._div.appendChild(a)
                        }
                ...
                return o(t, [{
                    ...
                    value: function(t) {
                        var e = t._layers;
                        for (var i in e)
                            if (e.hasOwnProperty(i) && (document.location.hash.substr(1).toLowerCase() === e[i].options.name ? e[i].options.name : "")) {
                    ...
                    value: function() {
                        ...
                        for (var n in i)
                            if (i.hasOwnProperty(n) && i[n] && i[n].title.toLowerCase() === e.toLowerCase()) {
                    ...
                    value: function(t) {
                        var e = this,
                            i = e.lastMarker;
                        i && i._icon && e.collapseMarker(i), t._zIndex += 1e3, t._icon.className += " expanded", e.lastMarker = t
                    }
                }, {
                    key: "collapseMarker",
                    value: function(t) {
                        t._icon.className = t._icon.className.replace("expanded", ""), this.lastMarker = void 0, t._zIndex -= 1e3, t.update()
                    }
                }, {
                    key: "toogleMarker",
                    value: function(t) {
                        var e = this;
                        t._icon.className.indexOf("expanded") + 1 ? e.collapseMarker(t) : e.expandMarker(t)
                    }
                }, {
                    key: "onClickOnMap",
                    value: function() {
                    ...
                    value: function(t) {
                        var e = this,
                            i = function(t) {
                                var e = "weather-none";
                                return t > -20 && t <= 6 && (e = "weather-cold"), t <= 2 && (e = "weather-very-cold"), t > 6 && t <= 20 && (e = "weather-average"), t > 20 && t <= 28 && (e = "weather-hot"), t > 28 && (e = "weather-very-hot"), e
                            };
                        return new L.TileLayer.GeoJSON(t, {
                            clipTiles: !0
                        }, {
                            pointToLayer: function(t, e) {
                                var n = t.properties.city.replace(" ", " "),
                                    o = t.properties.temp.toFixed(0);
                                "-0" === o && (o = "0");
                                var a = L.divIcon({
                                    className: "marker-default",
                                    html: ["<div>", '<span class="city-bullet"></span>', '<div class="city-data">', '<div class="row city-main-info">', '<span class="city-weather">' + o + " </span>", '<span class="city-name ' + i(o) + '">' + n + "</span>", "</div>", '<div class="row city-full-info">', "<table>", "<thead>", "<tr>", '<th colspan=2 class="city-param ' + i(o) + '">' + n + "</td>", "</tr>", "</thead>", "<tbody>", "<tr>", '<td class="city-param-name">country</td>', '<td class="city-param">' + t.properties.country + "</td>", "</tr>", "<tr>", '<td class="city-param-name">temp</td>', '<td class="city-param">' + t.properties.temp + "ºC</td>", "</tr>", "<tr>", '<td class="city-param-name">clouds</td>', '<td class="city-param">' + t.properties.clouds + "%</td>", "</tr>", "<tr>", '<td class="city-param-name">humidity</td>', '<td class="city-param">' + t.properties.humidity + "%</td>", "</tr>", "<tr>", '<td class="city-param-name">pressure</td>', '<td class="city-param">' + t.properties.pressure + "hPa</td>", "</tr>", "<tr>", '<td class="city-param-name">wind direction</td>', '<td class="city-param">' + t.properties.wind_deg + "°</td>", "</tr>", "<tr>", '<td class="city-param-name">wind speed</td>', '<td class="city-param">' + t.properties.wind_speed + "m/s</td>", "</tr>", "</tbody>", "</table>", "</div>", "</div>", "</div>"].join("")
                                });
                                return L.marker(e, {
                                    icon: a,
                                    riseOnHover: !0,
                            ...
                            onEachFeature: function(t, i) {
                                i instanceof L.Point || i.on("click", function(t) {
                    ...
                    key: "getCitiesLayer",
                    value: function(t) {
                        return new TileLayerGeoJSON(t, {}, {
                            pointToLayer: function(t, e) {
                                var i = t.properties.city.replace(" ", " "),
                                    n = L.divIcon({
                                        className: "marker-simple",
                                        html: ['<span class="city-simple-bullet"></span>', '<span class="city-lable">' + i + "</span>"].join("")
                                    });
                                return L.marker(e, {
                                    icon: n,
                                    riseOnHover: !0,
        ...
        var s = function() {
            ...
            _ = function(t) {
                function e(t) {
                    ...
                    return i.params = t, i.params.url = i.initialMechanicalURI(), i.layerFlag = !0, i.arrBasemap = [], i.latDefault = 30, i.lonDefault = -20, i.zoomDefault = "https:" === document.location.protocol ? 5 : 3, "map" === i.params.url.getData("basemap") ? (i.arrBasemap.push("map"), i.arrBasemap.push("satellite")) : (i.arrBasemap.push("satellite"), i.arrBasemap.push("map")), i
                }
                return r(e, t), s(e, [{
                    key: "iconLayers",
                    value: function(t) {
                        var e = [],
                            i = {
                                ...
                                icon: "/app/Weather/themes/owm/assets/vendor/owm/img/layers-satellite.png"
                            },
                            n = {
                                title: "map",
                                layer: this.layers.vector,
                                icon: "/app/Weather/themes/owm/assets/vendor/owm/img/layers-vector.png"
                            };
                        e.push(i), "map" === this.params.url.getData("basemap") ? e.unshift(n) : e.push(n);
                        ...
                        return this.getCurrentIconLayer = this.getCurrentIconLayer.bind(this), o.on("activelayerchange", this.getCurrentIconLayer), o
                    }
                }, {
                    key: "getCurrentIconLayer",
                    value: function() {
                        this.layerFlag ? this.params.url.setURIParamsNotReloadPage({
                    ...
                    value: function() {
                        var t = ["basemap", "cities", "layer", "lat", "lon", "zoom"],
                    ...
                    value: function(t) {
                        var e = {};
                        this.basemap = t.url.getData("basemap"), this.basemap || (e.basemap = "map"), this.layer = t.url.getData("layer"), this.layer || (e.layer = "temperature", this.layer = e.layer), this.cities = t.url.getData("cities"), this.cities || (e.cities = "true", this.cities = e.cities), this.lat = t.url.getData("lat"), this.lat || (e.lat = t.url.lat || t.lat || this.latDefault, this.lat = e.lat), this.lon = t.url.getData("lon"), this.lon || (e.lon = t.url.lon || t.lon || this.lonDefault, this.lon = e.lon), this.zoom = t.url.getData("zoom"), this.zoom || (e.zoom = this.zoomDefault, this.zoom = e.zoom), t.url.setURIParamsNotReloadPage(e), t.url.setActualLocation = document.location, t.url.compareData("cities", "true") ? this.params.flagCities.checked = !0 : this.params.flagCities.checked = !1
                    }
                }, {
                    key: "renderConditionPanelOverlay",
                    value: function() {
                        var t = document.createElement("div");
                        return map.appendChild(t), t.insertAdjacentHTML("afterBegin", '<div>\n        <input type="checkbox" class="weather-layer-container__checkbox" id="citiesConditions" style="padding-right: 5px;">\n        <label class="weather-layer-container__label" for="citiesConditions">Cities</label>\n       </div>\n       <img src="/app/Weather/themes/img/owm_icons/icon_chevron_up.png" id="img-toggle-overlays">'), t.className = "weather-layer-container__cities", t
                    }
                }, {
                    key: "locationSuccess",
                    value: function(t) {
                    ...
                    value: function() {
                        ...
                        t = t.bind(this), e = e.bind(this), (0, f.default)(t, e)
                    }
                }, {
                    key: "render",
                    value: function() {
                        function t() {
                            document.querySelectorAll(".weather-control-layers-selector").forEach(function(t) {
                                if (!t.checked) {
                                    var e = t.parentElement.style.display;
                                    t.parentElement.style.display = "none" === e ? "flex" : "none"
                                }
                            }), "rotate(180deg)" === this.style.webkitTransform ? this.style.webkitTransform = "none" : this.style.webkitTransform = "rotate(180deg)"
                        }
                        var e = arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : null,
                            i = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : null,
                            n = this.renderConditionPanelOverlay();
                        this.params.flagCities = document.getElementById("citiesConditions"), e && (this.params.lat = parseFloat(e, 10).toFixed(4)), i && (this.params.lon = parseFloat(i, 10).toFixed(4)), this.setDefaultLayers(this.params);
                        var o = L.map("map", {
                            worldCopyJump: !0,
                            minZoom: 3,
                            maxZoom: 10
                        }).setView([this.params.url.getData("lat") || e || this.latDefault, this.params.url.getData("lon") || i || this.lonDefault], this.params.url.getData("zoom") || this.zoomDefault);
                        if (this.layer)
                            for (var a in this.layers) this.layer === a && this.layers[a].addTo(o);
                        var r = {
                            ...
                            s = {};
                        this.params.layers = this.iconLayers(o), this.params.layer = this.layer, this.params.L = L;
                        var l = new h.default(o, this.params),
                            u = l.getCustomLayersControl(s, r);
                        o.addControl(u);
                        var c = document.querySelector(".weather-control-layers-new");
                        c && c.appendChild(n), document.getElementById("img-toggle-overlays").onclick = t, o.addControl(L.control.search());
                        var p = l.getWeatherLayer(this.baseURL + "/weather/cities/{z}/{x}/{y}.geojson?appid=" + this.params.appid).addTo(o),
                            d = L.tileLayer("http://{s}.basemaps.cartocdn.com/dark_only_labels/{z}/{x}/{y}.png", {
                                zIndex: 7
                            }).addTo(o);
                        l.bindCities("showWeather", p, d), l.bindScales();
                        var m = l.getPlayControl();
                        o.addControl(m), this.params.playBack = document.getElementById("play-back"), this.params.playBackFaster = document.getElementById("play-back-faster"), this.params.playForward = document.getElementById("play-forward"), this.params.playForwardFaster = document.getElementById("play-forward-faster"), this.params.play = document.getElementById("play"), this.params.stop = document.getElementById("stop"), this.params.currMoment = document.getElementById("current-moment"), this.params.minDate = document.getElementById("min-date"), this.params.maxDate = document.getElementById("max-date"), this.params.controlRange = document.getElementById("control-range"), l.bindPlayBack(o, m.enterDate)
                    }
                }]), e
            }(d.default);
        i.default = _
    ...
    10: [function(t, e, i) {
        ! function(i) {
            void 0 !== e && e.exports ? e.exports = i(t("leaflet")) : (window.L.control.iconLayers = i(window.L), window.L.Control.IconLayers = window.L.control.iconLayers.Constructor)
        }(function(t) {
            function e(t, e) {
            ...
            function i(t, e) {
                if (t.length) {
                    ...
                    for (var n in t)
                        if (t.hasOwnProperty(n) && e(t[n])) return t[n]
            }
            ...
            function a(t, e) {
                t.children.length ? t.insertBefore(e, t.children[0]) : t.appendChild(e)
            }
            var r = t.Control.extend({
                    includes: t.Mixin.Events,
                    _getActiveLayer: function() {
                        return this._activeLayerId ? this._layers[this._activeLayerId] : o(this._layers) ? n(this._layers) : null
                    },
                    _getPreviousLayer: function() {
                        var t = this._getActiveLayer();
                        return t ? this._previousLayerId ? this._layers[this._previousLayerId] : i(this._layers, function(e) {
                            return e.id !== t.id
                        }.bind(this)) || null : null
                    },
                    _getInactiveLayers: function() {
                        var t = [],
                            ...
                            n = this._getPreviousLayer() ? this._getPreviousLayer().id : null;
                        return e(this._layers, function(e) {
                    ...
                    _arrangeLayers: function() {
                        ...
                        return t.previous = function() {
                            ...
                            return this._getActiveLayer() && t.unshift(this._getActiveLayer()), this._getPreviousLayer() && t.unshift(this._getPreviousLayer()), t
                        }, t[this.options.behavior].apply(this, arguments)
                    },
                    _getLayerCellByLayerId: function(t) {
                        for (var e = this._container.getElementsByClassName("leaflet-iconLayers-layerCell"), i = 0; i < e.length; i++)
                    ...
                    _createLayerElement: function(e) {
                        ...
                        if (e.title) {
                            var n = t.DomUtil.create("div", "leaflet-iconLayers-layerTitleContainer"),
                                o = t.DomUtil.create("div", "leaflet-iconLayers-layerTitle"),
                                a = t.DomUtil.create("div", "leaflet-iconLayers-layerCheckIcon");
                            o.innerHTML = e.title, n.appendChild(o), i.appendChild(n), i.appendChild(a)
                        }
                        return e.icon && i.setAttribute("style", "background-image: url('" + e.icon + "')"), i
                    },
                    _createLayerElements: function() {
                        for (var e, i, n = this._arrangeLayers(), o = this._getActiveLayer() && this._getActiveLayer().id, r = 0; r < n.length; r++) r % this.options.maxLayersInRow == 0 && (e = t.DomUtil.create("div", "leaflet-iconLayers-layersRow"), -1 === this.options.position.indexOf("bottom") ? this._container.appendChild(e) : a(this._container, e)), i = t.DomUtil.create("div", "leaflet-iconLayers-layerCell"), i.setAttribute("data-layerid", n[r].id), 0 !== r && t.DomUtil.addClass(i, "leaflet-iconLayers-layerCell_hidden"), n[r].id === o && t.DomUtil.addClass(i, "leaflet-iconLayers-layerCell_active"), "left" === this._expandDirection ? t.DomUtil.addClass(i, "leaflet-iconLayers-layerCell_expandLeft") : t.DomUtil.addClass(i, "leaflet-iconLayers-layerCell_expandRight"), i.appendChild(this._createLayerElement(n[r])), -1 === this.options.position.indexOf("right") ? e.appendChild(i) : a(e, i)
                    },
                    ...
                    _attachEvents: function() {
                        e(this._layers, function(t) {
                            ...
                            e && e.addEventListener("click", this._onLayerClick.bind(this))
                        }.bind(this));
                        for (var t = this._container.getElementsByClassName("leaflet-iconLayers-layersRow"), i = function(t) {
                            ...
                            var r = t[a];
                            r.addEventListener("mouseenter", i), r.addEventListener("mouseleave", n), r.addEventListener("mousemove", o)
                        }
                    },
                    _render: function() {
                        this._container.innerHTML = "", this._createLayerElements(), this._attachEvents()
                    },
                    _switchMapLayers: function() {
                        if (this._map) {
                            var t = this._getActiveLayer(),
                                i = this._getPreviousLayer();
                            i ? this._map.removeLayer(i.layer) : e(this._layers, function(t) {
                                var e = t.layer;
                                this._map.removeLayer(e)
                            }.bind(this)), t && this._map.addLayer(t.layer)
                        }
                    },
                    options: {
                        position: "bottomleft",
                    ...
                    initialize: function(e, i) {
                        t.Util.isArray(arguments[0]) || (i = e, e = []), t.setOptions(this, i), this._expandDirection = -1 != this.options.position.indexOf("left") ? "right" : "left", this.options.manageLayers && this.on("activelayerchange", this._switchMapLayers, this), this.setLayers(e)
                    },
                    onAdd: function(e) {
                        return this._container = t.DomUtil.create("div", "leaflet-iconLayers"), t.DomUtil.addClass(this._container, "leaflet-iconLayers_" + this.options.position), this._render(), e.on("click", this.collapse, this), this.options.manageLayers && this._switchMapLayers(), this._container
                    },
                    onRemove: function(t) {
                        t.off("click", this.collapse, this)
                    },
                    setLayers: function(e) {
                        this._layers = {}, e.map(function(e) {
                            var i = t.stamp(e.layer);
                            this._layers[i] = t.extend(e, {
                                id: i
                            })
                        }.bind(this)), this._container && this._render()
                    },
                    setActiveLayer: function(e) {
                        var i = e && this._layers[t.stamp(e)];
                        i && i.id !== this._activeLayerId && (this._previousLayerId = this._activeLayerId, this._activeLayerId = i.id, this._container && this._render(), this.fire("activelayerchange", {
                            layer: e
                        }))
                    },
                    expand: function() {
                        this._arrangeLayers().slice(1).map(function(e) {
                            var i = this._getLayerCellByLayerId(e.id);
                            t.DomUtil.removeClass(i, "leaflet-iconLayers-layerCell_hidden")
                        }.bind(this))
                    },
                    collapse: function() {
                        this._arrangeLayers().slice(1).map(function(e) {
                            var i = this._getLayerCellByLayerId(e.id);
                            t.DomUtil.addClass(i, "leaflet-iconLayers-layerCell_hidden")
                        }.bind(this))
                    }
                }),
                s = function(t, e) {
    ...
    11: [function(t, e, i) {
        ! function(t, i, n) {
            var o = t.L,
                a = {};
            a.version = "0.7.7", "object" == typeof e && "object" == typeof e.exports ? e.exports = a : "function" == typeof define && define.amd && define(a), a.noConflict = function() {
                    return t.L = o, this
                }, t.L = a, a.Util = {
                    extend: function(t) {
                        var e, i, n, o, a = Array.prototype.slice.call(arguments, 1);
            ...
            a.Mixin = {}, a.Mixin.Events = {
                    addEventListener: function(t, e, i) {
                        ...
                        for (t = a.Util.splitWords(t), n = 0, o = t.length; n < o; n++) s = {
                            action: e,
                            context: i || this
                    ...
                    fireEvent: function(t, e) {
                        ...
                        var i, n, o, s, l, h = a.Util.extend({}, e, {
                            ...
                            u = this[r];
                        if (u[t])
                            for (i = u[t].slice(), n = 0, o = i.length; n < o; n++) i[n].action.call(i[n].context, h);
                        s = u[t + "_idx"];
                        for (l in s)
                            if (i = s[l].slice())
                                for (n = 0, o = i.length; n < o; n++) i[n].action.call(i[n].context, h);
                        return this
                    },
                ...
                function() {
                    var e = "ActiveXObject" in t,
                        ...
                        v = "WebKitCSSMatrix" in t && "m11" in new t.WebKitCSSMatrix && !u,
                        y = "MozPerspective" in _.style,
                        L = "OTransition" in _.style,
                        b = !t.L_DISABLE_3D && (g || v || y || L) && !l,
                        P = !t.L_NO_TOUCH && !l && (m || "ontouchstart" in t || t.DocumentTouch && i instanceof t.DocumentTouch);
                    a.Browser = {
                        ie: e,
                        ielt9: n,
                        webkit: r,
                    ...
                    return t instanceof a.Point ? t : a.Util.isArray(t) ? new a.Point(t[0], t[1]) : void 0 === t || null === t ? t : new a.Point(t, e, i)
                    ...
                    getViewportOffset: function(t) {
                        var e, n = 0,
                            ...
                            l = i.documentElement;
                        do {
                            if (n += r.offsetTop || 0, o += r.offsetLeft || 0, n += parseInt(a.DomUtil.getStyle(r, "borderTopWidth"), 10) || 0, o += parseInt(a.DomUtil.getStyle(r, "borderLeftWidth"), 10) || 0, e = a.DomUtil.getStyle(r, "position"), r.offsetParent === s && "absolute" === e) break;
                            if ("fixed" === e) {
                            ...
                            if ("relative" === e && !r.offsetLeft) {
                                ...
                                "none" === h && "none" === u || (o += c.left + r.clientLeft), n += c.top + (s.scrollTop || l.scrollTop || 0);
                                break
                            }
                            r = r.offsetParent
                        } while (r);
                    ...
                    documentIsLtr: function() {
                        return a.DomUtil._docIsLtrCached || (a.DomUtil._docIsLtrCached = !0, a.DomUtil._docIsLtr = "ltr" === a.DomUtil.getStyle(i.body, "direction")), a.DomUtil._docIsLtr
                    },
                    ...
                    addClass: function(t, e) {
                        if (void 0 !== t.classList)
                            for (var i = a.Util.splitWords(e), n = 0, o = i.length; n < o; n++) t.classList.add(i[n]);
                    ...
                    removeClass: function(t, e) {
                        void 0 !== t.classList ? t.classList.remove(e) : a.DomUtil._setClass(t, a.Util.trim((" " + a.DomUtil._getClass(t) + " ").replace(" " + e + " ", " ")))
                    },
                    ...
                    getScaleString: function(t, e) {
                        return a.DomUtil.getTranslateString(e.add(e.multiplyBy(-1 * t))) + " scale(" + t + ") "
                    },
                ...
                a.DomUtil.TRANSITION = a.DomUtil.testProp(["webkitTransition", "transition", "OTransition", "MozTransition", "msTransition"]), a.DomUtil.TRANSITION_END = "webkitTransition" === a.DomUtil.TRANSITION || "OTransition" === a.DomUtil.TRANSITION ? a.DomUtil.TRANSITION + "End" : "transitionend",
                function() {
                    if ("onselectstart" in i) a.extend(a.DomUtil, {
                        ...
                        var e = a.DomUtil.testProp(["userSelect", "WebkitUserSelect", "OUserSelect", "MozUserSelect", "msUserSelect"]);
                        a.extend(a.DomUtil, {
                            disableTextSelection: function() {
                                if (e) {
                    ...
                    equals: function(t) {
                        return !!t && (t = a.latLng(t), Math.max(Math.abs(this.lat - t.lat), Math.abs(this.lng - t.lng)) <= a.LatLng.MAX_MARGIN)
                    },
                    toString: function(t) {
                    ...
                    wrap: function(t, e) {
                        var i = this.lng;
                        return t = t || -180, e = e || 180, i = (i + e) % (e - t) + (i < t || i === e ? e : t), new a.LatLng(this.lat, i)
                    }
                }, a.latLng = function(t, e) {
                    return t instanceof a.LatLng ? t : a.Util.isArray(t) ? "number" == typeof t[0] || "string" == typeof t[0] ? new a.LatLng(t[0], t[1], t[2]) : null : void 0 === t || null === t ? t : "object" == typeof t && "lat" in t ? new a.LatLng(t.lat, "lng" in t ? t.lng : t.lon) : void 0 === e ? null : new a.LatLng(t, e)
                    ...
                    equals: function(t) {
                        return !!t && (t = a.latLngBounds(t), this._southWest.equals(t.getSouthWest()) && this._northEast.equals(t.getNorthEast()))
                    },
                    isValid: function() {
                    ...
                    project: function(t) {
                        var e = a.LatLng.DEG_TO_RAD,
                            ...
                            o = t.lng * e,
                            r = n * e;
                        return r = Math.log(Math.tan(Math.PI / 4 + r / 2)), new a.Point(o, r)
                    },
                    ...
                    initialize: function(t, e) {
                        e = a.setOptions(this, e), this._initContainer(t), this._initLayout(), this._onResize = a.bind(this._onResize, this), this._initEvents(), e.maxBounds && this.setMaxBounds(e.maxBounds), e.center && void 0 !== e.zoom && this.setView(a.latLng(e.center), e.zoom, {
                            reset: !0
                        }), this._handlers = [], this._layers = {}, this._zoomBoundLayers = {}, this._tileLayersNum = 0, this.callInitHooks(), this._addLayers(e.layers)
                    },
                    setView: function(t, e) {
                        return e = void 0 === e ? this.getZoom() : e, this._resetView(a.latLng(t), this._limitZoom(e)), this
                    },
                    ...
                    invalidateSize: function(t) {
                        ...
                        var i = this.getSize(),
                            ...
                            r = n.subtract(o);
                        return r.x || r.y ? (t.animate && t.pan ? this.panBy(r) : (t.pan && this._rawPanBy(r), this.fire("move"), t.debounceMoveend ? (clearTimeout(this._sizeTimer), this._sizeTimer = setTimeout(a.bind(this.fire, this, "moveend"), 200)) : this.fire("moveend")), this.fire("resize", {
                            oldSize: e,
                            newSize: i
                        })) : this
                    },
                    ...
                    getBoundsZoom: function(t, e, i) {
                        ...
                        i = a.point(i || [0, 0]);
                        do {
                            o++, n = this.project(h, o).subtract(this.project(l, o)).add(i), u = e ? n.x < s.x || n.y < s.y : s.contains(n)
                        } while (u && o <= r);
                    ...
                    project: function(t, e) {
                        return e = void 0 === e ? this._zoom : e, this.options.crs.latLngToPoint(a.latLng(t), e)
                    },
                    unproject: function(t, e) {
                        return e = void 0 === e ? this._zoom : e, this.options.crs.pointToLatLng(a.point(t), e)
                    },
                    ...
                    latLngToLayerPoint: function(t) {
                        return this.project(a.latLng(t))._round()._subtract(this.getPixelOrigin())
                    },
                    ...
                    _initEvents: function(e) {
                        if (a.DomEvent) {
                            e = e || "on", a.DomEvent[e](this._container, "click", this._onMouseClick, this);
                            var i, n, o = ["dblclick", "mousedown", "mouseup", "mouseenter", "mouseleave", "mousemove", "contextmenu"];
                            for (i = 0, n = o.length; i < n; i++) a.DomEvent[e](this._container, o[i], this._fireMouseEvent, this);
                            this.options.trackResize && a.DomEvent[e](t, "resize", this._onResize, this)
                        }
                    },
                    _onResize: function() {
                    ...
                    unproject: function(t) {
                        for (var e, i = a.LatLng.RAD_TO_DEG, n = this.R_MAJOR, o = this.R_MINOR, r = t.x * i / n, s = o / n, l = Math.sqrt(1 - s * s), h = Math.exp(-t.y / n), u = Math.PI / 2 - 2 * Math.atan(h), c = 15, p = .1; Math.abs(p) > 1e-7 && --c > 0;) e = l * Math.sin(u), p = Math.PI / 2 - 2 * Math.atan(h * Math.pow((1 - e) / (1 + e), .5 * l)) - u, u += p;
                    ...
                    _setAutoZIndex: function(t, e) {
                        var i, n, o, a = t.children,
                            r = -e(1 / 0, -1 / 0);
                        for (n = 0, o = a.length; n < o; n++) a[n] !== this._container && (i = parseInt(a[n].style.zIndex, 10), isNaN(i) || (r = e(r, i)));
                    ...
                    _initContainer: function() {
                        ...
                        if (!this._container) {
                            if (this._container = a.DomUtil.create("div", "leaflet-layer"), this._updateZIndex(), this._animated) {
                                this._bgBuffer = a.DomUtil.create("div", "leaflet-tile-container", this._container), this._tileContainer = a.DomUtil.create("div", "leaflet-tile-container", this._container)
                    ...
                    _addTilesFromCenterOut: function(t) {
                        ...
                        for (e = t.min.y; e <= t.max.y; e++)
                            for (n = t.min.x; n <= t.max.x; n++) o = new a.Point(n, e), this._tileShouldBeLoaded(o) && r.push(o);
                        var l = r.length;
                        if (0 !== l) {
                            r.sort(function(t, e) {
                            ...
                            for (this._tilesToLoad || this.fire("loading"), this._tilesToLoad += l, n = 0; n < l; n++) this._addTile(r[n], h);
                    ...
                    _tileShouldBeLoaded: function(t) {
                        ...
                        if (e.bounds) {
                            ...
                            if (e.continuousWorld || e.noWrap || (r = r.wrap(), s = s.wrap()), !e.bounds.intersects([r, s])) return !1
                        }
                        return !0
                    },
                    ...
                    _createTile: function() {
                        ...
                        return t.style.width = t.style.height = this._getTileSize() + "px", t.galleryimg = "no", t.onselectstart = t.onmousemove = a.Util.falseFn, a.Browser.ielt9 && void 0 !== this.options.opacity && a.DomUtil.setOpacity(t, this.options.opacity), a.Browser.mobileWebkit3d && (t.style.WebkitBackfaceVisibility = "hidden"), t
                    },
                    _loadTile: function(t, e) {
                    ...
                    getTileUrl: function(t) {
                        var e = this._map,
                            ...
                            l = this._wmsVersion >= 1.3 && this._crs === a.CRS.EPSG4326 ? [s.y, r.x, r.y, s.x].join(",") : [r.x, s.y, s.x, r.y].join(","),
                    ...
                    _animateZoom: function(t) {
                        var e = this._map,
                            ...
                            l = e._latLngToNewLayerPoint(r, t.zoom, t.center)._subtract(s),
                            h = s._add(l._multiplyBy(.5 * (1 - 1 / n)));
                    ...
                    var t, e, n, o, a = i.getElementsByTagName("script"),
                        r = /[\/^]leaflet[\-\._]?([\w\-\._]*)\.js\??/;
                    for (t = 0, e = a.length; t < e; t++)
                        if (n = a[t].src, n.match(r)) return o = n.split(r)[0], (o ? o + "/" : "") + "images"
                    ...
                    _initIcon: function() {
                        var t = this.options,
                            ...
                            r = !1;
                        o !== this._icon && (this._icon && this._removeIcon(), r = !0, t.title && (o.title = t.title), t.alt && (o.alt = t.alt)), a.DomUtil.addClass(o, n), t.keyboard && (o.tabIndex = "0"), this._icon = o, this._initInteraction(), t.riseOnHover && a.DomEvent.on(o, "mouseover", this._bringToFront, this).on(o, "mouseout", this._resetZIndex, this);
                        var s = t.icon.createShadow(this._shadow),
                            l = !1;
                        s !== this._shadow && (this._removeShadow(), l = !0), s && a.DomUtil.addClass(s, n), this._shadow = s, t.opacity < 1 && this._updateOpacity();
                        var h = this._map._panes;
                        r && h.markerPane.appendChild(this._icon), s && l && h.shadowPane.appendChild(this._shadow)
                    },
                    ...
                    createIcon: function(t) {
                        var e = t && "DIV" === t.tagName ? t : i.createElement("div"),
                            n = this.options;
                        return !1 !== n.html ? e.innerHTML = n.html : e.innerHTML = "", n.bgPos && (e.style.backgroundPosition = -n.bgPos.x + "px " + -n.bgPos.y + "px"), this._setIconStyles(e, "icon"), e
                    },
                    ...
                    _updateLayout: function() {
                        ...
                        o && n > o ? (e.height = o + "px", a.DomUtil.addClass(t, "leaflet-popup-scrolled")) : a.DomUtil.removeClass(t, "leaflet-popup-scrolled"), this._containerWidth = this._container.offsetWidth
                    },
                    ...
                    _adjustPan: function() {
                        if (this.options.autoPan) {
                            ...
                            var o = t.layerPointToContainerPoint(n),
                                ...
                                u = 0,
                                c = 0;
                            o.x + i + l.x > h.x && (u = o.x + i - h.x + l.x), o.x - u - s.x < 0 && (u = o.x - s.x), o.y + e + l.y > h.y && (c = o.y + e - h.y + l.y), o.y - c - s.y < 0 && (c = o.y - s.y), (u || c) && t.fire("autopanstart").panBy([u, c])
                        }
                    },
                    ...
                    removeLayer: function(t) {
                        return this.hasLayer(t) ? (t in this._layers && (t = this._layers[t]), "off" in t && t.off(a.FeatureGroup.EVENTS, this._propagateEvent, this), a.LayerGroup.prototype.removeLayer.call(this, t), this._popupContent && this.invoke("unbindPopup"), this.fire("layerremove", {
                            layer: t
                        })) : this
                    },
                    bindPopup: function(t, e) {
                ...
                }), a.Path.SVG_NS = "http://www.w3.org/2000/svg", a.Browser.svg = !(!i.createElementNS || !i.createElementNS(a.Path.SVG_NS, "svg").createSVGRect), a.Path = a.Path.extend({
                    statics: {
                        SVG: a.Browser.svg
                    },
                    bringToFront: function() {
                    ...
                    _updateSvgViewport: function() {
                        if (!this._pathZooming) {
                            ...
                            a.Browser.mobileWebkit && s.removeChild(r), a.DomUtil.setPosition(r, e), r.setAttribute("width", n), r.setAttribute("height", o), r.setAttribute("viewBox", [e.x, e.y, n, o].join(" ")), a.Browser.mobileWebkit && s.appendChild(r)
                        }
                    }
                }), a.Path.include({
                    bindPopup: function(t, e) {
                ...
                }(), a.Path = a.Path.SVG && !t.L_PREFER_CANVAS || !a.Browser.canvas ? a.Path : a.Path.extend({
                    statics: {
                        CANVAS: !0,
                        SVG: !1
                    },
                    ...
                    _drawPath: function() {
                        ...
                        for (this._ctx.beginPath(), t = 0, i = this._parts.length; t < i; t++) {
                            for (e = 0, n = this._parts[t].length; e < n; e++) o = this._parts[t][e], r = (0 === e ? "move" : "line") + "To", this._ctx[r](o.x, o.y);
                ...
                }), a.Map.include(a.Path.SVG && !t.L_PREFER_CANVAS || !a.Browser.canvas ? {} : {
                    _initPathRoot: function() {
                    ...
                    _simplifyDPStep: function(t, e, i, n, o) {
                        var a, r, s, l = 0;
                        for (r = n + 1; r <= o - 1; r++)(s = this._sqClosestPointOnSegment(t[r], t[n], t[o], !0)) > l && (a = r, l = s);
                        l > i && (e[a] = 1, this._simplifyDPStep(t, e, i, n, a), this._simplifyDPStep(t, e, i, a, o))
                    },
                    _reducePoints: function(t, e) {
                        for (var i = [t[0]], n = 1, o = 0, a = t.length; n < a; n++) this._sqDist(t[n], t[o]) > e && (i.push(t[n]), o = n);
                        return o < a - 1 && i.push(t[a - 1]), i
                    },
                    clipSegment: function(t, e, i, n) {
                        var o, a, r, s = n ? this._lastCode : this._getBitCode(t, i),
                            l = this._getBitCode(e, i);
                        for (this._lastCode = l;;) {
                            if (!(s | l)) return [t, e];
                            if (s & l) return !1;
                            o = s || l, a = this._getEdgeIntersection(t, e, o, i), r = this._getBitCode(a, i), o === s ? (t = a, s = r) : (e = a, l = r)
                        }
                    },
                    _getEdgeIntersection: function(t, e, i, n) {
                        var o = e.x - t.x,
                            ...
                            s = n.min,
                            l = n.max;
                        return 8 & i ? new a.Point(t.x + o * (l.y - t.y) / r, l.y) : 4 & i ? new a.Point(t.x + o * (s.y - t.y) / r, s.y) : 2 & i ? new a.Point(l.x, t.y + r * (l.x - t.x) / o) : 1 & i ? new a.Point(s.x, t.y + r * (s.x - t.x) / o) : void 0
                    },
                    ...
                    _sqClosestPointOnSegment: function(t, e, i, n) {
                        var o, r = e.x,
                            ...
                            h = i.y - s,
                            u = l * l + h * h;
                        return u > 0 && (o = ((t.x - r) * l + (t.y - s) * h) / u, o > 1 ? (r = i.x, s = i.y) : o > 0 && (r += l * o, s += h * o)), l = t.x - r, h = t.y - s, n ? l * l + h * h : new a.Point(r, s)
                    }
                    ...
                    closestLayerPoint: function(t) {
                        for (var e, i, n = 1 / 0, o = this._parts, r = null, s = 0, l = o.length; s < l; s++)
                            for (var h = o[s], u = 1, c = h.length; u < c; u++) {
                                e = h[u - 1], i = h[u];
                                var p = a.LineUtil._sqClosestPointOnSegment(t, e, i, !0);
                                p < n && (n = p, r = a.LineUtil._sqClosestPointOnSegment(t, e, i))
                            }
                    ...
                    _getPathPartStr: function(t) {
                        for (var e, i = a.Path.VML, n = 0, o = t.length, r = ""; n < o; n++) e = t[n], i && e._round(), r += (n ? "L" : "M") + e.x + " " + e.y;
                        return r
                    },
                    _clipPoints: function() {
                        ...
                        var r = this._parts,
                            ...
                            l = a.LineUtil;
                        for (t = 0, e = 0; t < o - 1; t++)(i = l.clipSegment(n[t], n[t + 1], s, t)) && (r[e] = r[e] || [], r[e].push(i[0]), i[1] === n[t + 1] && t !== o - 2 || (r[e].push(i[1]), e++))
                    },
                    _simplifyPoints: function() {
                        for (var t = this._parts, e = a.LineUtil, i = 0, n = t.length; i < n; i++) t[i] = e.simplify(t[i], this.options.smoothFactor)
                    },
                    _updatePath: function() {
                    ...
                    var i, n, o, r, s, l, h, u, c, p = [1, 4, 2, 8],
                        d = a.LineUtil;
                    for (n = 0, h = t.length; n < h; n++) t[n]._code = d._getBitCode(t[n], e);
                    for (r = 0; r < 4; r++) {
                        for (u = p[r], i = [], n = 0, h = t.length, o = h - 1; n < h; o = n++) s = t[n], l = t[o], s._code & u ? l._code & u || (c = d._getEdgeIntersection(l, s, u, e), c._code = d._getBitCode(c, e), i.push(c)) : (l._code & u && (c = d._getEdgeIntersection(l, s, u, e), c._code = d._getBitCode(c, e), i.push(c)), i.push(s));
                        t = i
                    }
                    return t
                    ...
                    _getPathPartStr: function(t) {
                        return a.Polyline.prototype._getPathPartStr.call(this, t) + (a.Browser.svg ? "z" : "x")
                    }
                ...
                function() {
                    ...
                    _containsPoint: function(t, e) {
                        var i, n, o, r, s, l, h = this.options.weight / 2;
                        for (a.Browser.touch && (h += 10), i = 0, r = this._parts.length; i < r; i++)
                            for (l = this._parts[i], n = 0, s = l.length, o = s - 1; n < s; o = n++)
                                if ((e || 0 !== n) && a.LineUtil.pointToSegmentDistance(t, l[o], l[n]) <= h) return !0;
                        return !1
                    }
                } : {}), a.Polygon.include(a.Path.CANVAS ? {
                    _containsPoint: function(t) {
                        var e, i, n, o, r, s, l, h, u = !1;
                        if (a.Polyline.prototype._containsPoint.call(this, t, !0)) return !0;
                        for (o = 0, l = this._parts.length; o < l; o++)
                            for (e = this._parts[o], r = 0, h = e.length, s = h - 1; r < h; s = r++) i = e[r], n = e[s], i.y > t.y != n.y > t.y && t.x < (n.x - i.x) * (t.y - i.y) / (n.y - i.y) + i.x && (u = !u);
                        return u
                    }
                    ...
                    addData: function(t) {
                        ...
                        var r = this.options;
                        if (!r.filter || r.filter(t)) {
                            var s = a.GeoJSON.geometryToLayer(t, r.pointToLayer, r.coordsToLatLng, r);
                            return s.feature = a.GeoJSON.asFeature(t), s.defaultOptions = s.options, this.resetStyle(s), r.onEachFeature && r.onEachFeature(t, s), this.addLayer(s)
                        }
                    },
                    ...
                    geometryToLayer: function(t, e, i, n) {
                        var o, r, s, l, h = "Feature" === t.type ? t.geometry : t,
                            u = h.coordinates,
                            c = [];
                        switch (i = i || this.coordsToLatLng, h.type) {
                            ...
                            case "MultiPoint":
                                for (s = 0, l = u.length; s < l; s++) o = i(u[s]), c.push(e ? e(t, o) : new a.Marker(o));
                                return new a.FeatureGroup(c);
                            case "LineString":
                                return r = this.coordsToLatLngs(u, 0, i), new a.Polyline(r, n);
                            case "Polygon":
                                if (2 === u.length && !u[1].length) throw new Error("Invalid GeoJSON object.");
                                return r = this.coordsToLatLngs(u, 1, i), new a.Polygon(r, n);
                            case "MultiLineString":
                                return r = this.coordsToLatLngs(u, 1, i), new a.MultiPolyline(r, n);
                            case "MultiPolygon":
                                return r = this.coordsToLatLngs(u, 2, i), new a.MultiPolygon(r, n);
                            case "GeometryCollection":
                                for (s = 0, l = h.geometries.length; s < l; s++) c.push(this.geometryToLayer({
                    ...
                    coordsToLatLngs: function(t, e, i) {
                        var n, o, a, r = [];
                        for (o = 0, a = t.length; o < a; o++) n = e ? this.coordsToLatLngs(t[o], e - 1, i) : (i || this.coordsToLatLng)(t[o]), r.push(n);
                        return r
                    },
                    ...
                    latLngsToCoords: function(t) {
                        for (var e = [], i = 0, n = t.length; i < n; i++) e.push(a.GeoJSON.latLngToCoords(t[i]));
                        return e
                    },
            ...
            a.Marker.include(s), a.Circle.include(s), a.CircleMarker.include(s), a.Polyline.include({
                    toGeoJSON: function() {
                        return a.GeoJSON.getFeature(this, {
                            type: "LineString",
                    ...
                    toGeoJSON: function() {
                        ...
                        if (n[0].push(n[0][0]), this._holes)
                            for (t = 0, e = this._holes.length; t < e; t++) i = a.GeoJSON.latLngsToCoords(this._holes[t]), i.push(i[0]), n.push(i);
                        return a.GeoJSON.getFeature(this, {
                            type: "Polygon",
                            coordinates: n
                        })
                ...
                function() {
                    ...
                    _getEvent: function() {
                        var e = t.event;
                        if (!e)
                            for (var i = arguments.callee.caller; i && (!(e = i.arguments[0]) || t.Event !== e.constructor);) i = i.caller;
                        return e
                    },
                    _filterClick: function(t, e) {
                        var i = t.timeStamp || t.originalEvent.timeStamp,
                            n = a.DomEvent._lastClick && i - a.DomEvent._lastClick;
                        return n && n > 100 && n < 500 || t.target._simulatedClick && !t._simulated ? void a.DomEvent.stop(t) : (a.DomEvent._lastClick = i, e(t))
                    }
                    ...
                    _onDown: function(t) {
                        if (this._moved = !1, !t.shiftKey && (1 === t.which || 1 === t.button || t.touches) && (a.DomEvent.stopPropagation(t), !a.Draggable._disabled && (a.DomUtil.disableImageDrag(), a.DomUtil.disableTextSelection(), !this._moving))) {
                            ...
                            this._startPoint = new a.Point(e.clientX, e.clientY), this._startPos = this._newPos = a.DomUtil.getPosition(this._element), a.DomEvent.on(i, a.Draggable.MOVE[t.type], this._onMove, this).on(i, a.Draggable.END[t.type], this._onUp, this)
                        }
                    },
                    _onMove: function(t) {
                    ...
                    _onUp: function() {
                        a.DomUtil.removeClass(i.body, "leaflet-dragging"), this._lastTarget && (a.DomUtil.removeClass(this._lastTarget, "leaflet-drag-target"), this._lastTarget = null);
                        for (var t in a.Draggable.MOVE) a.DomEvent.off(i, a.Draggable.MOVE[t], this._onMove).off(i, a.Draggable.END[t], this._onUp);
                    ...
                    addDoubleTapListener: function(t, e, n) {
                        function o(t) {
                            var e;
                            if (a.Browser.pointer ? (d.push(t.pointerId), e = d.length) : e = t.touches.length, !(e > 1)) {
                                var i = Date.now(),
                                    n = i - (s || i);
                                l = t.touches ? t.touches[0] : t, h = n > 0 && n <= u, s = i
                            }
                        }
                        ...
                        return t.addEventListener(c, o, !1), m.addEventListener(p, r, !1), a.Browser.pointer && m.addEventListener(a.DomEvent.POINTER_CANCEL, r, !1), this
                    },
                    removeDoubleTapListener: function(t, e) {
                        var n = "_leaflet_";
                        return t.removeEventListener(this._touchstart, t[n + this._touchstart + e], !1), (a.Browser.pointer ? i.documentElement : t).removeEventListener(this._touchend, t[n + this._touchend + e], !1), a.Browser.pointer && i.documentElement.removeEventListener(a.DomEvent.POINTER_CANCEL, t[n + this._touchend + e], !1), this
                    }
                }), a.extend(a.DomEvent, {
                    ...
                    addPointerListenerStart: function(t, e, n, o) {
                        var r = this._pointers,
                            s = function(t) {
                                "mouse" !== t.pointerType && t.pointerType !== t.MSPOINTER_TYPE_MOUSE && a.DomEvent.preventDefault(t);
                    ...
                    addPointerListenerMove: function(t, e, i, n) {
                        ...
                        return t["_leaflet_touchmove" + n] = o, t.addEventListener(this.POINTER_MOVE, o, !1), this
                    },
                    addPointerListenerEnd: function(t, e, i, n) {
                        ...
                        return t["_leaflet_touchend" + n] = a, t.addEventListener(this.POINTER_UP, a, !1), t.addEventListener(this.POINTER_CANCEL, a, !1), this
                    },
                    ...
                    _onTouchStart: function(t) {
                        ...
                        if (t.touches && 2 === t.touches.length && !e._animatingZoom && !this._zooming) {
                            ...
                            this._startCenter = n.add(o)._divideBy(2), this._startDist = n.distanceTo(o), this._moved = !1, this._zooming = !0, this._centerOffset = r.subtract(this._startCenter), e._panAnim && e._panAnim.stop(), a.DomEvent.on(i, "touchmove", this._onTouchMove, this).on(i, "touchend", this._onTouchEnd, this), a.DomEvent.preventDefault(t)
                        }
                    },
                    ...
                    _onTouchEnd: function() {
                        ...
                        var t = this._map;
                        this._zooming = !1, a.DomUtil.removeClass(t._mapPane, "leaflet-touching"), a.Util.cancelAnimFrame(this._animRequest), a.DomEvent.off(i, "touchmove", this._onTouchMove).off(i, "touchend", this._onTouchEnd);
                    ...
                    _onDown: function(t) {
                        if (t.touches) {
                            ...
                            var e = t.touches[0],
                                n = e.target;
                            this._startPos = this._newPos = new a.Point(e.clientX, e.clientY), n.tagName && "a" === n.tagName.toLowerCase() && a.DomUtil.addClass(n, "leaflet-active"), this._holdTimeout = setTimeout(a.bind(function() {
                                this._isTapValid() && (this._fireClick = !1, this._onUp(), this._simulateEvent("contextmenu", e))
                            }, this), 1e3), a.DomEvent.on(i, "touchmove", this._onMove, this).on(i, "touchend", this._onUp, this)
                        }
                    },
                    _onUp: function(t) {
                        if (clearTimeout(this._holdTimeout), a.DomEvent.off(i, "touchmove", this._onMove, this).off(i, "touchend", this._onUp, this), this._fireClick && t && t.changedTouches) {
                            var e = t.changedTouches[0],
                                n = e.target;
                            n && n.tagName && "a" === n.tagName.toLowerCase() && a.DomUtil.removeClass(n, "leaflet-active"), this._isTapValid() && this._simulateEvent("click", e)
                        }
                    },
                    ...
                    _onMouseDown: function(t) {
                        ...
                        a.DomUtil.disableTextSelection(), a.DomUtil.disableImageDrag(), this._startLayerPoint = this._map.mouseEventToLayerPoint(t), a.DomEvent.on(i, "mousemove", this._onMouseMove, this).on(i, "mouseup", this._onMouseUp, this).on(i, "keydown", this._onKeyDown, this)
                    },
                    _onMouseMove: function(t) {
                        ...
                        a.DomUtil.setPosition(i, r), this._moved = !0, i.style.width = Math.max(0, Math.abs(o.x) - 4) + "px", i.style.height = Math.max(0, Math.abs(o.y) - 4) + "px"
                    },
                    _finish: function() {
                        this._moved && (this._pane.removeChild(this._box), this._container.style.cursor = ""), a.DomUtil.enableTextSelection(), a.DomUtil.enableImageDrag(), a.DomEvent.off(i, "mousemove", this._onMouseMove).off(i, "mouseup", this._onMouseUp).off(i, "keydown", this._onKeyDown)
                    },
                    ...
                    _createButton: function(t, e, i, n, o, r) {
                        ...
                        return a.DomEvent.on(s, "click", l).on(s, "mousedown", l).on(s, "dblclick", l).on(s, "click", a.DomEvent.preventDefault).on(s, "click", o, r).on(s, "click", this._refocusOnMap, r), s
                    },
                    ...
                    options: {
                        position: "bottomright",
                        prefix: '<a href="https://hauhet.co" title="interactive maps">HauHet plc.</a>'
                    },
                    initialize: function(t) {
                    ...
                    _update: function() {
                        var t = this._map.getBounds(),
                            ...
                            a = this.options,
                            r = 0;
                        o.x > 0 && (r = n * (a.maxWidth / o.x)), this._updateScales(a, r)
                    },
                    ...
                    _updateImperial: function(t) {
                        var e, i, n, o = 3.2808399 * t,
                            a = this._iScale;
                        o > 5280 ? (e = o / 5280, i = this._getRoundNum(e), a.style.width = this._getScaleWidth(i / e) + "px", a.innerHTML = i + " mi") : (n = this._getRoundNum(o), a.style.width = this._getScaleWidth(n / o) + "px", a.innerHTML = n + " ft")
                    },
                    ...
                    _addItem: function(t) {
                        ...
                        t.overlay ? (e = i.createElement("input"), e.type = "checkbox", e.className = "leaflet-control-layers-selector", e.defaultChecked = o) : e = this._createRadioElement("leaflet-base-layers", o), e.layerId = a.stamp(t.layer), a.DomEvent.on(e, "click", this._onInputClick, this);
                        var r = i.createElement("span");
                        return r.innerHTML = " " + t.name, n.appendChild(e), n.appendChild(r), (t.overlay ? this._overlaysList : this._baseLayersList).appendChild(n), n
                    },
                    _onInputClick: function() {
                        var t, e, i, n = this._form.getElementsByTagName("input"),
                            o = n.length;
                    ...
                    _getPos: function() {
                        ...
                        if (a.Browser.any3d) {
                            if (!(n = r[a.DomUtil.TRANSFORM].match(this._transformRe))) return;
                    ...
                    setView: function(t, e, i) {
                        if (e = void 0 === e ? this._zoom : this._limitZoom(e), t = this._limitCenter(a.latLng(t), e, this.options.maxBounds), i = i || {}, this._panAnim && this._panAnim.stop(), this._loaded && !i.reset && !0 !== i) {
                            void 0 !== i.animate && (i.zoom = a.extend({
                                animate: i.animate
                    ...
                    _tryAnimatedZoom: function(t, e, i) {
                        ...
                        return !(!0 !== i.animate && !this.getSize().contains(o)) && (this.fire("movestart").fire("zoomstart"), this._animateZoom(t, e, a, n, null, !0), !0)
                    },
                    _animateZoom: function(t, e, i, n, o, r, s) {
                        s || (this._animatingZoom = !0), a.DomUtil.addClass(this._mapPane, "leaflet-zoom-anim"), this._animateToCenter = t, this._animateToZoom = e, a.Draggable && (a.Draggable._disabled = !0), a.Util.requestAnimFrame(function() {
                            this.fire("zoomanim", {
                                center: t,
                                zoom: e,
                                origin: i,
                    ...
                    _onZoomTransitionEnd: function() {
                        this._animatingZoom && (this._animatingZoom = !1, a.DomUtil.removeClass(this._mapPane, "leaflet-zoom-anim"), a.Util.requestAnimFrame(function() {
                            this._resetView(this._animateToCenter, this._animateToZoom, !0, !0), a.Draggable && (a.Draggable._disabled = !1)
                        }, this))
                    }
                } : {}), a.TileLayer.include({
                    _animateZoom: function(t) {
                    ...
                    _prepareBgBuffer: function() {
                        ...
                        e.style.visibility = "hidden", e.style[a.DomUtil.TRANSFORM] = "", this._tileContainer = e, e = this._bgBuffer = t, this._stopLoadingImages(e), clearTimeout(this._clearBgBufferTimer)
                    },
                    ...
                    _stopLoadingImages: function(t) {
                        ...
                        for (e = 0, i = o.length; e < i; e++) n = o[e], n.complete || (n.onload = a.Util.falseFn, n.onerror = a.Util.falseFn, n.src = a.Util.emptyImageUrl, n.parentNode.removeChild(n))
                    }
                }), a.Map.include({
    ...
    12: [function(t, e, i) {
        ! function(t, n) {
            "object" == typeof i && "object" == typeof e ? e.exports = n() : "function" == typeof define && define.amd ? define([], n) : "object" == typeof i ? i.parseURI = n() : t.parseURI = n()
        }(window, function() {
            return function(t) {
                function e(n) {
                ...
                var o = i(94),
                    ...
                    s = i(91),
                    l = i(90);
                n.prototype.clear = o, n.prototype.delete = a, n.prototype.get = r, n.prototype.has = s, n.prototype.set = l, t.exports = n
            }, function(t, e, i) {
                var n = i(12),
                    o = i(20);
                t.exports = function(t) {
                ...
                var n = i(52),
                    ...
                    l = n(function() {
                        ...
                        return o(t) && r.call(t, "callee") && !s.call(t, "callee")
                    };
                t.exports = l
            }, function(t, e) {
                ...
                var n = i(11),
                    o = i(6);
                t.exports = function(t, e, i) {
                    (void 0 === i || o(t[e], i)) && (void 0 !== i || e in t) || n(t, e, i)
                }
            }, function(t, e, i) {
                (function(e) {
                ...
                t.exports = function(t, e, i) {
                    if (!r(i)) return !1;
                    var s = typeof e;
                    return !!("number" == s ? o(i) && a(e, i.length) : "string" == s && e in i) && n(i[e], t)
                }
            }, function(t, e) {
                var i = Date.now;
                t.exports = function(t) {
                ...
                t.exports = function(t) {
                    return n(function(e, i) {
                        var n = -1,
                            ...
                            r = a > 1 ? i[a - 1] : void 0,
                            s = a > 2 ? i[2] : void 0;
                        for (r = t.length > 3 && "function" == typeof r ? (a--, r) : void 0, s && o(i[0], i[1], s) && (r = a < 3 ? void 0 : r, a = 1), e = Object(e); ++n < a;) {
                            var l = i[n];
                            l && t(e, l, n, r)
                        }
                        return e
                ...
                t.exports = function(t, e) {
                    var i = a(t),
                        ...
                        f = m.length;
                    for (var _ in t) !e && !h.call(t, _) || d && ("length" == _ || c && ("offset" == _ || "parent" == _) || p && ("buffer" == _ || "byteLength" == _ || "byteOffset" == _) || s(_, f)) || m.push(_);
                    return m
                }
            }, function(t, e, i) {
                var n = i(11),
                ...
                t.exports = function(t, e, i) {
                    var r = t[e];
                    a.call(t, e) && o(r, i) && (void 0 !== i || e in t) || n(t, e, i)
                }
            }, function(t, e, i) {
                var n = i(43),
                    o = i(11);
                    ...
                    if (w) n(t, i, w);
                        ...
                        if (T) {
                            var E = h(x),
                                D = !E && c(x),
                                S = !E && !D && f(x);
                            C = x, E || D || S ? h(P) ? C = P : u(P) ? C = r(P) : D ? (T = !1, C = o(x, !0)) : S ? (T = !1, C = a(x, !0)) : C = [] : m(x) || l(x) ? (C = P, l(P) ? C = g(P) : (!d(P) || v && p(P)) && (C = s(x))) : T = !1
                        }
                ...
                t.exports = function(t) {
                    return function(e, i, n) {
                        for (var o = -1, a = Object(e), r = n(e), s = r.length; s--;) {
                            var l = r[t ? s : ++o];
                ...
                t.exports = function(t, e) {
                    ...
                    if (i instanceof n) {
                        var r = i.__data__;
                        if (!o || r.length < 199) return r.push([t, e]), this.size = ++i.size, this;
                ...
                var o = i(8),
                    ...
                    l = i(86),
                    h = i(85);
                n.prototype.clear = a, n.prototype.delete = r, n.prototype.get = s, n.prototype.has = l, n.prototype.set = h, t.exports = n
            }, function(t, e, i) {
                var n = i(95),
                    o = i(26),
                    a = i(63),
                ...
                e.parseHash = function(t) {
                    ...
                    return void 0 === e && (e = !1), t.origin.length ? e ? {
                    ...
                    if (t.search.length) {
                        var e = {};
                        return t.search.replace("?", "").split("&").forEach(function(t) {
                            var i = t.split("="),
                                a = i[0],
                                r = i[1];
                            ! function(t, e, i) {
                                if (-1 !== e.indexOf("[")) {
                                    for (var a = e.replace("[]", "[$empty$]").split(/\[|\]/).filter(function(t) {
                                            return t.length > 0
                                        }), r = {}, s = r; a.length;) {
                                        var l = a.shift();
                                        if (a.length >= 1) {
                                            if (n(l)) throw new Error("error");
                                            r[l] ? r = r[l] : parseInt(l).toString() === l ? r[parseInt(l)] ? r = r[parseInt(l)] : (r[parseInt(l)] = {}, r = r[parseInt(l)]) : (n(a[0]) || parseInt(a[0]).toString() === a[0] ? r[l] || (r[l] = []) : r[l] || (r[l] = {}), r = r[l])
                                        } else n(l) ? Array.isArray(r) ? r.push(i) : r = [i] : r[l] = i
                                    }
                                    o(t, s, function(t, e) {
                                        if (Array.isArray(t)) return t.concat(e).filter(function(t) {
                                            return void 0 !== t
                                        })
                                    })
                                } else t[e] = i
        ...
        (function(t) {
            ! function(t) {
                ...
                "URLSearchParams" in t && "a=1" === new t.URLSearchParams("?a=1").toString() || function() {
                    ...
                    a.append = function(t, e) {
                        ...
                        for (var n in this._entries)
                            if (this._entries.hasOwnProperty(n)) {
                                i = this._entries[n];
                                for (var o = 0; o < i.length; o++) t.call(e, i[o], n, this)
                            }
                    }, a.keys = function() {
                        var t = [];
                    ...
                    }, e && (a[Symbol.iterator] = a.entries), a.toString = function() {
                        var t = [];
                        return this.forEach(function(e, i) {
                            t.push(n(i) + "=" + n(e))
                        }), t.join("&")
                ...
                "function" != typeof a.sort && (a.sort = function() {
                    ...
                    value: function(t) {
                        ...
                        t = t.replace(/^\?/, "");
                        for (var n, a = t.split("&"), i = 0; i < a.length; i++) n = a[i].split("="), this.append(o(n[0]), n.length > 1 ? o(n[1]) : "")
                    }
                })
                        ...
                        var e = t.URL,
                            i = function(e, i) {
                                ...
                                if (i && (void 0 === t.location || i !== t.location.href)) {
                                    o = document.implementation.createHTMLDocument(""), n = o.createElement("base"), n.href = i, o.head.appendChild(n);
                                    try {
                                ...
                                if (a.href = e, n && (o.body.appendChild(a), a.href = a.href), ":" === a.protocol || !/:/.test(a.href)) throw new TypeError("Invalid URL");
                                ...
                                ["append", "delete", "set"].forEach(function(t) {
                                    var e = r[t];
                                    r[t] = function() {
                                        e.apply(r, arguments), s && (l = !1, h.search = r.toString(), l = !0)
                                    }
